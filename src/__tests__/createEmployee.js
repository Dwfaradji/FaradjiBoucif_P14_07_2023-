...
// Test de la page createEmployee en tant qu'employer.
...
// Test de la fonctionnalité de création d'employer (CreateEmployee) en tant qu'employer.
describe("En tant qu'employer je veux accéder au formulaire, Afin d'ajouter un employer a la liste", () => {
    ...
    test('ÉTANT DONNÉ que le formulaire est rempli correctement, QUAND le bouton Save est cliqué, ALORS une modal avec le message "Employee Created !" devrait être affichée', () => {
        ...
        fireEvent.change(screen.getByLabelText('Start Date'), {target: {value: '2023-08-01'}});
...
// Test de la navbar pour la navigation entre les pages
