...
const CreateEmployee = () => {
    ...
    const handleFormDateChange = (name, date) => {
        setEmployee({
            ...employee, [name]: new Date(date).toLocaleDateString("fr")
        });
    };
    /* Dropdown */
        ...
        <div className="container-first column-flex">
            ...
            <div className="container">
                ...
                <div className="container-form">
                    <form onSubmit={saveEmployee} className="column-flex" id="create-employee">
                        ...
                        <input className="date-picker-input" type="date" id="date-of-birth" name="dateOfBirth"
                               onChange={(date) => {
                                   handleFormDateChange("dateOfBirth", date.target.value);
                               }}/>

                        <label htmlFor="start-date">Start Date</label>
                        <input type="date" className="date-picker-input" id="start-date" onChange={(date) => {
                        ...
                        <fieldset className="address column-flex">
                            ...
                            <input id="street" type="text" name="street" onChange={handleFormChange}/>

                            <label htmlFor="city">City</label>
                            <input id="city" type="text" name="city" onChange={handleFormChange}/>

                            <label htmlFor="state">State</label>
                            <Dropdown name="state"
                                      onChangeDropdown={(value) => handleFormDropdownChange("state", value)}
                                      optionsList={States}/>

                            <label htmlFor="zip-code">Zip Code</label>
                            <input id="zip-code" type="number" name="zipCode" onChange={handleFormChange}/>
                        </fieldset>

                        <label htmlFor="department">Department</label>
                        <Dropdown name="department"
                                  id="department"
                                  onChangeDropdown={(value) => handleFormDropdownChange("department", value)}
